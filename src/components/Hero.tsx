...
export const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center bg-gradient-dark relative overflow-hidden">
      {/* Interactive Background Elements */}
      <div className="absolute inset-0">
        {/* Main interactive orb that follows mouse */}
        <div className="absolute w-96 h-96 bg-primary/30 rounded-full blur-3xl transition-all duration-700 ease-out" style={{
        ...
        <div className="absolute w-80 h-80 bg-secondary/25 rounded-full blur-3xl transition-all duration-1000 ease-out" style={{
        ...
        <div className="absolute w-72 h-72 bg-accent/20 rounded-full blur-3xl transition-all duration-500" style={{
        ...
        {/* Floating particles */}
        {[...Array(8)].map((_, i) => <div key={i} className="absolute w-2 h-2 bg-primary/40 rounded-full blur-sm animate-float" style={{
