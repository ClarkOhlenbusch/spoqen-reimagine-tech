...
const mainNavItems = [
  ...
  { title: "Active Calls", url: "/dashboard/calls", icon: Phone },
...
export function DashboardSidebar() {
  ...
  const getNavClasses = (path: string) =>
    isActive(path) 
      ? "bg-primary/20 text-primary border-r-2 border-primary shadow-glow-primary/20" 
      : "text-muted-foreground hover:bg-card/30 hover:text-foreground"

  return (
    <Sidebar collapsible="icon">
      <SidebarContent className="bg-card/20 backdrop-blur-glass border-r border-white/10">
        {/* Logo Section */}
